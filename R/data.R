...
#' @title peacock
#' @description Observations of female presence before and after peacock solo hoot calls from Roslyn and Montgomerie (2013).
...
#'   \item{\code{TimeofHoot}}{character Time of hoot}
#'   \item{\code{AudienceMales}}{character Indicator of whether there was  at least one other male present on the lek}
#'   \item{\code{FemaleVisit.5m}}{integer The number of females within 5 m of each male }
#'}
#' @source  Data are from Dakin, R., & Montgomerie, R. (2014). Deceptive copulation calls attract female visitors to peacock leks. The American Naturalist, 183(4), 558-564.
#'
...
#'}
#' @source \url{https://datadryad.org/stash/dataset/doi:10.5061/dryad.238b2}
#'
